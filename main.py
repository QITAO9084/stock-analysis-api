...
def get_trading_signal(data, symbol):
    ...
    return {
        ...
        "signal": signal_type,
        "confidence": "HIGH" if (rsi < 30 or rsi > 70) else "MEDIUM",
        "signals": signals,
        "indicators": {
            "rsi": round(rsi, 2),
            "macd": macd_data,
...
def analyze_stock(symbol: str = "AAPL", market: str = "us"):
    ...
    try:
        ...
        return {
            ...
            "technical_indicators": signal_data["indicators"],
